#!/usr/bin/env python3
"""Genera un PDF con texto enriquecido a partir de patron-mvc.md"""
import markdown
from fpdf import FPDF
from fpdf.fonts import FontFace

MD_PATH = "backend/docs/patron-mvc.md"
PDF_PATH = "backend/docs/patron-mvc.pdf"
...
class PDF(FPDF):
    ...
    def header(self):
        if self.page_no() > 1:
            ...
            self.cell(0, 8, "Patron MVC en el backend", align="R")
            self.ln(4)
