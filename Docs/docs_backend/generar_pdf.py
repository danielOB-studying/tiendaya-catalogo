#!/usr/bin/env python3
"""Genera un PDF con texto enriquecido a partir de driver-jdbc-bloqueante.md"""
import markdown
from fpdf import FPDF
from fpdf.fonts import FontFace

MD_PATH = "backend/docs/driver-jdbc-bloqueante.md"
PDF_PATH = "backend/docs/driver-jdbc-bloqueante.pdf"
...
class PDF(FPDF):
    ...
    def header(self):
        if self.page_no() > 1:
            ...
            self.cell(0, 8, "Driver JDBC tradicional y bloqueante en el backend", align="R")
            self.ln(4)
