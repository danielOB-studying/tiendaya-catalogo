#!/usr/bin/env python3
"""Genera un PDF con texto enriquecido a partir de programacion-reactiva.md"""
import markdown
from fpdf import FPDF
from fpdf.fonts import FontFace

MD_PATH = "frontend/docs/programacion-reactiva.md"
PDF_PATH = "frontend/docs/programacion-reactiva.pdf"
...
class PDF(FPDF):
    ...
    def header(self):
        if self.page_no() > 1:
            ...
            self.cell(0, 8, "Programación reactiva en el frontend", align="R")
            self.ln(4)
